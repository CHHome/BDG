  ...
  <div>
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i>招募管理</a></li>
          <li class="active">招募工作总结报告</li>
        </ol>
      </section>
          ...
          <div class="col-md-12">
            <div class="box" >
              <div class="box-header with-border">
                <h3 class="box-title">招募工作总结报告</h3>
...
//        searchUrl:"search",//加上查参数
    ...
    methods:{
      getData(){
        this.$http.get(this.requestUrl,{params:{type:'rec',page:this.currentPage}})
          .then(res => {
