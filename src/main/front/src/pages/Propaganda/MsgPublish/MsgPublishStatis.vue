          ...
          <div class="col-md-12">
            <div class="box" >
              <div class="box-header with-border">
                <h3 class="box-title">宣传信息发布统计</h3>
  ...
  export default {
    ...
    data(){
      return {
        ...
        tableData:null,
        viewId:1,
        currentKey:[{title:"No.",key:'id'},{title:"负责人",key:'name'},{title:'电视媒体类',key:'dianshi'},
...
//        searchUrl:"search",//加上查参数
    ...
    methods:{
      getData(){
        this.$http.get(this.requestUrl,{params:{type:'pubMsgStatic',page:this.currentPage}})
          .then(res => {
